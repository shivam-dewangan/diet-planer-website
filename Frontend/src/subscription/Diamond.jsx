...
import "../subscription/Diamond.css";
...
export default function Diamond() {
 ...
 <h1 className="meal-heading">Select Your <a>Diamond Meal</a>  Type</h1>
  <div className="card-group">
    ...
    <div className="meal-card" onClick={()=> handleSelect("Non-Veg")}>
      <h2>🍗 Non-Veg Plan</h2>
    ...
    {/* 🚫 Inactive Mix Plan */}
    <div className="meal-card" on onClick={()=> handleSelect("Mix")}>
      <h2>🍱 Mix Plan</h2>
